...
class ShopSettings(Base):
    ...
    indirizzo: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    ...
    provincia: Mapped[str] = mapped_column(String(2), nullable=False, default="")
    codice_fiscale: Mapped[str] = mapped_column(String(16), nullable=False, default="")
    ...
    regime_fiscale: Mapped[str] = mapped_column(String(32), nullable=False, default="margine")
